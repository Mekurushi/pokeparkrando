from patcher.helper.entrance_exit_names import BEACH_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION
...
EMAPA02_Z01 = PatchPattern(
    name="EMAPA02_Z01",
    description="Beach Zone -> Treehouse Connection",
    patternJP=[
        Instruction(
    ...
    patchMapJP=[
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                ...
                plando_dict,
                BEACH_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION, "zone"
            ),
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                                  pattern_name: get_exit_zone_area_position_data(
                plando_dict,
                BEACH_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION, "area"
            ),
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                                  pattern_name: get_exit_zone_area_position_data(
                plando_dict,
                BEACH_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION, "position"
            ),
...
evAr03Zn01_ScriptEvent_patch_pattern = [
    EMAPA02_Z01,
]
