from patcher.helper.entrance_exit_names import HAUNTED_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION
...
EMAPA02_Z01 = PatchPattern(
    name="EMAPA02_Z01",
    description="Haunted Zone -> Treehouse Connection",
    patternJP=[
        Instruction(
    ...
    patchMapJP=[
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, matches: get_exit_zone_area_position_data(
                plando_dict,
                HAUNTED_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION, "zone"
            ),
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, matches: get_exit_zone_area_position_data(
                plando_dict,
                HAUNTED_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION, "area"
            ),
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, matches: get_exit_zone_area_position_data(
                plando_dict,
                HAUNTED_ZONE_MAIN_AREA_TREEHOUSE_CONNECTION, "position"
            ),
...
evAr05Zn01_ScriptEvent_patch_pattern = [
    EMAPA02_Z01,
]
