from patcher.helper.patttern_handler import parse_pattern_bytes, create_lstr_instruction_fsb, patch_taxi_stop
...
f0302FuwarideTaxiStop_Ar01Zn01 = PatchPattern(
    ...
    patternJP=[
        Instruction(
            identifier=1, offset=0x0,
            pattern=parse_pattern_bytes("66 30 33 30 32 46 75 77 61 72 69 64 65 54 61 78 69 53 74 6f 70 00"),
...
f0401FuwarideTaxiStop_Ar01Zn01 = PatchPattern(
    ...
    patternJP=[
        Instruction(
            identifier=1, offset=0x0,
            pattern=parse_pattern_bytes("66 30 34 30 31 46 75 77 61 72 69 64 65 54 61 78 69 53 74 6f 70 00"),
...
string_section_start = PatchPattern(
    ...
    patternJP=[
        Instruction(
            identifier=1, offset=0x0,
            pattern=parse_pattern_bytes("65 76 41 72 30 31 5a 6e 30 31 5f 47 69 6d 6d 69 63 00"),
...
caterpie_tree_gimmic = PatchPattern(
    ...
    patternJP=[
        Instruction(
            identifier=1, offset=0x0, pattern=parse_pattern_bytes("00 0a 00 10"),
        ...
        Instruction(
            identifier=3, offset=0x8, pattern=parse_pattern_bytes("00 29 00 10"),
        ...
        #
        Instruction(
            identifier=5, offset=0x1c, pattern=parse_pattern_bytes("00 e7 02 08"),
            instruction_readable="jz"
        ),
        Instruction(
            identifier=6, offset=0x20, pattern=parse_pattern_bytes("00 01 00 10"),
            instruction_readable="push 0x1"
        ),
        Instruction(
            identifier=7, offset=0x24, pattern=parse_pattern_bytes("00 ?? ?? 13"),
            instruction_readable="lstr zfTreeCatapi"
        ),
        #
        #
        Instruction(
            identifier=8, offset=0x34, pattern=parse_pattern_bytes("00 0d 00 10"),
            instruction_readable="push 0xd"
        ),
        Instruction(
            identifier=9, offset=0x40, pattern=parse_pattern_bytes("?? ?? ?? 03"),
    ...
    patchMapJP=[
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: create_lstr_instruction_fsb(
                patch_patterns, string_section_start.name, f0301FuwarideTaxiStop_Ar01Zn01.name
            ),
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: create_lstr_instruction_fsb(
                ...
                f0301FuwarideTaxiStop_Ar01Zn01.name
            ),
            new_instruction_readable="f0101HideAndSeek"
        ),
...
weedle_tree_gimmic_logic = PatchPattern(
    ...
    patternJP=[
        ...
        Instruction(
            identifier=2, offset=0x4, pattern=parse_pattern_bytes("ff fd 00 0b"),
            instruction_readable="load_arg -0x3"
        ),
        Instruction(
            identifier=3, offset=0x8, pattern=parse_pattern_bytes("00 0a 00 10"),
            instruction_readable="push 0xa"
        ),
        Instruction(
            identifier=4, offset=0xc, pattern=parse_pattern_bytes("00 15 03 01"),
        ...
        Instruction(
            identifier=7, offset=0x1c, pattern=parse_pattern_bytes("00 f0 02 08"),
            instruction_readable="jz"
        ),
        Instruction(
            identifier=5, offset=0x24, pattern=parse_pattern_bytes("?? ?? ?? 13"),
            instruction_readable="lstr zfTreeBeedle"
        ),
        Instruction(
            identifier=6, offset=0x1d0, pattern=parse_pattern_bytes("?? ?? ?? 03"),
    ...
    patchMapJP=[
        Patch(
            identifier=5,
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: create_lstr_instruction_fsb(
                patch_patterns, string_section_start.name, f0302FuwarideTaxiStop_Ar01Zn01.name
            ),
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: create_lstr_instruction_fsb(
                patch_patterns, string_section_start.name,
                f0302FuwarideTaxiStop_Ar01Zn01.name
            ),
            new_instruction_readable="f0101HideAndSeek"
        ),
        Patch(
...
weedle_tree_gimmic = PatchPattern(
    ...
    patternJP=[
        Instruction(
            identifier=1, offset=0x0, pattern=parse_pattern_bytes("ff fd 00 0b"),
            instruction_readable="load_arg -0x3"
        ),
        Instruction(
            identifier=2, offset=0x4, pattern=parse_pattern_bytes("ff fc 00 0b"),
...
shroomish_box_gimmic = PatchPattern(
    ...
    patternJP=[
        Instruction(
            identifier=1, offset=0x0, pattern=parse_pattern_bytes("00 0e 00 10"),
    ...
    patchMapJP=[
        Patch(
            identifier=1,
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: create_lstr_instruction_fsb(
                patch_patterns, string_section_start.name, f0401FuwarideTaxiStop_Ar01Zn01.name
            ),
...
unlock_function = PatchPattern(
    ...
    patchMapJP=[
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: create_lstr_instruction_fsb(
                patch_patterns, string_section_start.name,
                f0401FuwarideTaxiStop_Ar01Zn01.name
            ),
            new_instruction_readable="f0101TalkMankey"
        ),
        Patch(
...
taxi_stop = PatchPattern(
    name="meadow taxi stop",
    description="removing zone drifblim unlock",
    patternJP=[
        Instruction(
            identifier=1, offset=0x0, pattern=parse_pattern_bytes("00 1a 00 07"),
            instruction_readable="grow_stack 0x1a"
        ),
        Instruction(
        ...
        Instruction(
            identifier=4, offset=0x1c, pattern=parse_pattern_bytes("4e 37 00 10"),
            instruction_readable="push 0x4e37"
        ),
        Instruction(
            identifier=5, offset=0x70, pattern=parse_pattern_bytes("00 00 00 12"),
            instruction_readable="push_result"
        ),
        Instruction(
            identifier=6, offset=0x420, pattern=parse_pattern_bytes("00 1b 00 06"),
            instruction_readable="ret -0x1b"
        ),
    ],
    patchMapJP=[
        Patch(
