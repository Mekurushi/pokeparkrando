...
attraction_result = PatchPattern(
    ...
    patternJP=[
        ...
        Instruction(
            identifier=2, offset=0x12c, pattern=parse_pattern_bytes("00 14 02 08"),
            instruction_readable="jz"
        ),
        Instruction(
            identifier=3, offset=0x130, pattern=parse_pattern_bytes("ff fd 00 0b"),
            instruction_readable="load_arg -0x3"
        ),
        Instruction(
            identifier=4, offset=0x134, pattern=parse_pattern_bytes("ff fe 00 0b"),
            instruction_readable="load_arg -0x2"
        ),
        Instruction(
            identifier=5, offset=0x138, pattern=parse_pattern_bytes("00 51 00 10"),
            instruction_readable="push 0x51"
        ),
        Instruction(
            identifier=6, offset=0x13c, pattern=parse_pattern_bytes("00 15 03 01"),
        ...
        Instruction(
            identifier=7, offset=0x210, pattern=parse_pattern_bytes("00 01 00 10"),
            instruction_readable="push 0x1"
        ),
        Instruction(
            identifier=8, offset=0x214, pattern=parse_pattern_bytes("ff fd 00 0b"),
            instruction_readable="load_arg -0x3"
        ),
        Instruction(
            identifier=9, offset=0x218, pattern=parse_pattern_bytes("ff fe 00 0b"),
            instruction_readable="load_arg -0x2"
        ),
        Instruction(
            identifier=10, offset=0x21c, pattern=parse_pattern_bytes("00 52 00 10"),
            instruction_readable="push 0x52"
        ),
        Instruction(
            identifier=11, offset=0x220, pattern=parse_pattern_bytes("00 15 04 01"),
            instruction_readable="SC4 0x0:0x15"
        ),
        Instruction(
            identifier=12, offset=0x224, pattern=parse_pattern_bytes("00 01 00 10"),
            instruction_readable="push 0x1"
        ),
    ],
    patchMapJP=[
...
attraction_start_demo = PatchPattern(
    ...
    patternJP=[
        ...
        # prisma state request
        Instruction(
            identifier=2, offset=0xe0, pattern=parse_pattern_bytes("00 1b 02 08"),
            instruction_readable="jz"
        ),
        Instruction(
            identifier=3, offset=0xe4, pattern=parse_pattern_bytes("ff fd 00 0b"),
            instruction_readable="load_arg -0x3"
        ),
        Instruction(
            identifier=4, offset=0xe8, pattern=parse_pattern_bytes("ff fe 00 0b"),
            instruction_readable="load_arg -0x2"
        ),
        Instruction(
            identifier=5, offset=0xec, pattern=parse_pattern_bytes("00 51 00 10"),
            instruction_readable="push 0x51"
        ),
        Instruction(
            identifier=6, offset=0xf0, pattern=parse_pattern_bytes("00 15 03 01"),
            instruction_readable="SC3 0x0:0x15"
        ),
...
attraction_start_demo_end = PatchPattern(
    ...
    patternJP=[
        ...
        # prisma state request
        Instruction(
            identifier=2, offset=0xe0, pattern=parse_pattern_bytes("00 0e 02 08"),
            instruction_readable="jz"
        ),
        Instruction(
            identifier=3, offset=0xe4, pattern=parse_pattern_bytes("ff fd 00 0b"),
...
condition_legendary_friendship = PatchPattern(
    ...
    patternJP=[
        ...
        Instruction(
            identifier=3, offset=0xd0, pattern=parse_pattern_bytes("00 3d 00 10"),
...
set_friendship = PatchPattern(
    ...
    patternJP=[
        ...
        Instruction(
            identifier=2, offset=0x30, pattern=parse_pattern_bytes("00 01 00 0b"),
            instruction_readable="load_arg 0x1"
        ),
        Instruction(
            identifier=3, offset=0x34, pattern=parse_pattern_bytes("ff ff 00 0b"),
            instruction_readable="load_arg -0x1"
        ),
        Instruction(
            identifier=4, offset=0x38, pattern=parse_pattern_bytes("00 3c 00 10"),
            instruction_readable="push 0x3c"
        ),
        Instruction(
            identifier=5, offset=0x3c, pattern=parse_pattern_bytes("00 15 03 01"),
            instruction_readable="SC3 0x0:0x15"
        ),
    ],
    patchMapJP=[
