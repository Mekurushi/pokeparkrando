...
f0402FireWallB = PatchPattern(
    ...
    patternJP=[
        Instruction(identifier=1, offset=0x0, pattern=parse_pattern_bytes("66 30 34 30 32 46 69 72 65 57 61 6c 6c 42 00"),
    ...
    patchMapJP=[
        Patch(
            identifier=1,
            patch_function=lambda offset, data, plando_dict, matches: (0x66303430324669726557616c6c4100).to_bytes(15,
                                                                                                                  'big'),
