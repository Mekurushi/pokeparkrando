...
prisma_check = PatchPattern(
    ...
    patternJP=[
        ...
        Instruction(
            identifier=2, offset=0x10c, pattern=parse_pattern_bytes("00 08 02 08"),
            instruction_readable="jz"
        ),
        Instruction(
            identifier=3, offset=0x110, pattern=parse_pattern_bytes("00 00 00 0b"),
            instruction_readable="load_arg 0x0"
        ),
        Instruction(
            identifier=4, offset=0x114, pattern=parse_pattern_bytes("ff fe 00 0b"),
            instruction_readable="load_arg -0x2"
        ),
        Instruction(
            identifier=5, offset=0x118, pattern=parse_pattern_bytes("00 51 00 10"),
            instruction_readable="push 0x51"
        ),
        Instruction(
            identifier=6, offset=0x11c, pattern=parse_pattern_bytes("00 15 03 01"),
...
postgame_check = PatchPattern(
    ...
    patternJP=[
        ...
        Instruction(
            identifier=2, offset=0xa4, pattern=parse_pattern_bytes("00 00 00 12"),
