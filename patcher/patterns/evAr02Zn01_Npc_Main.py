    ...
    patchMapJP=[
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                ...
                custom_prisma_check_function.name
            ),
...
treehouse_additional_pokemon_spawn_conditions = PatchPattern(
    ...
    patchMapJP=[
        ...
        Patch(
            identifier=6,
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: (0x00040108).to_bytes(
                4, 'big'
            ),
...
abra_interaction = PatchPattern(
    ...
    patchMapJP=[
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                                  pattern_name: compute_call_instruction_fsb(
                offset, patch_patterns, set_best_friend_function.name
            ),
...
piplup_interaction = PatchPattern(
    ...
    patchMapJP=[
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                                  pattern_name: compute_call_instruction_fsb(
                offset, patch_patterns, custom_prisma_amount_function.name
            ),
        ...
        Patch(
            identifier=5,
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: (0x000f0016).to_bytes(
                4, 'big'
            ),
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                                  pattern_name: compute_call_instruction_fsb(
                offset, patch_patterns, run_interaction_dialog.name
            ),
...
custom_prisma_amount_function = PatchPattern(
    ...
    patchMapJP=[
        ...
        Patch(
            ...
            patch_function=lambda offset, data, plando_dict, patch_patterns,
                                  pattern_name: compute_call_instruction_fsb(
                offset, patch_patterns, custom_prisma_check_function.name
            ),
        ...
        Patch(
            identifier=8,
            patch_function=lambda offset, data, plando_dict, patch_patterns, pattern_name: (0x00000014).to_bytes(
                4, 'big'
            ),
...
evAr02Zn01_Npc_Main_pattern = [
    ...
    set_chapter,
    get_friendship,
    set_best_friend_function,
    run_interaction_dialog,
    get_module,
    gate_open_logic,
