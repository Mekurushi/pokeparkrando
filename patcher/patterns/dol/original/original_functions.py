...
custom_functions_cgu0_global_manager_syscall_handler = PatchPattern(
    name="custom_functions_cgu0_global_manager_syscall_handler",
    patternJP=[
        Instruction(
...
original_dol_pattern = [
    ...
    custom_functions_cgu0_global_manager_syscall_handler,
