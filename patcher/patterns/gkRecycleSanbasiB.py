...
string_section_start = PatchPattern(
    ...
    patternJP=[
        Instruction(
            ...
            pattern=parse_pattern_bytes("47 6b 52 65 63 79 63 6c 65 53 61 6e 62 61 73 69 42 00"),
            instruction_readable="ds GkRecycleSanbasiB"
        ),
